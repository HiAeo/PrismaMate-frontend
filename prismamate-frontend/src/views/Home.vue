  ...
  <PublicLayout>
    ...
    <section class="hero-section">
      ...
      <div class="announcement-bar">
        ...
        <span class="announcement-text">{{ t('home.announcement') }}</span>
      </div>

      <div class="hero-grid">
        <!-- 左侧文案 -->
        <div class="hero-left">
          <div class="hero-tag"><span class="tag-dot"></span>{{ t('home.tag') }}</div>
          <h1 class="hero-title">
            <span class="title-line">{{ t('home.title1') }}</span>
            <span class="title-line">{{ t('home.title2') }}</span>
          </h1>
          <p class="hero-subtitle">{{ t('home.subtitle') }}</p>
          <div class="hero-buttons">
            <a href="/health-check/new" class="hero-btn">
              {{ t('home.btnHealthCheck') }}
            </a>
            <a href="/geo-verification" class="hero-btn">
              {{ t('home.btnGeoVerify') }}
            </a>
            <a href="/verify" class="hero-btn">
              {{ t('home.btnReportVerify') }}
            </a>
          </div>
        </div>
          ...
          <div class="cards-container">
            ...
            >
              ...
              <div class="card-metrics">
                <div class="metric">
                  <span class="metric-label">{{ t('home.metricMentions') }}</span>
                  <span class="metric-value">{{ card.mentions }}</span>
                </div>
                <div class="metric">
                  <span class="metric-label">{{ t('home.metricRank') }}</span>
              ...
              <div class="card-chart">
                ...
                <span class="chart-score">{{ card.score }}{{ t('home.scoreUnit') }}</span>
              </div>
            </div>
          </div>
        </div>
